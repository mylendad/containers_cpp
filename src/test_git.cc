...
{
    s21::map<std::string, int> myMap = {
        {"ключ01", 1}, {"ключ02", 2}, {"ключ03", 3}, {"ключ04", 4}, {"ключ05", 5}, {"ключ06", 6}, {"ключ07", 7}, {"ключ08", 8}, {"ключ09", 9}, {"ключ10", 10}};

    // myMap.print_start();

    s21::map<std::string, int> myMap_1 = {
        {"ключ10", 1}, {"ключ09", 2}, {"ключ08", 3}, {"ключ07", 4}, {"ключ06", 5}, {"ключ05", 6}, {"ключ04", 7}, {"ключ03", 8}, {"ключ02", 9}, {"ключ01", 10}
...
{
    s21::map<int, int> a{{21, 21}, {172, 172}, {1, 1}, {17, 17}, {199, 199}, {42, 42}, {58, 58}, {322, 322}, {2, 2}, {88, 88}};
