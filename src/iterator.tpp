...
s21::tree<T, AllowDuplicate>::TreeIterator::TreeIterator()
    : current_(nullptr), nil_(nullptr), end_node_(nullptr) {}

template <typename T, int AllowDuplicate>
s21::tree<T, AllowDuplicate>::TreeIterator::TreeIterator(BaseNode* node,
                                                         BaseNode*& nil,
                                                         BaseNode*& end_node) {
  this->current_ = node;
  this->nil_ = nil;
...
template <typename T, int AllowDuplicate>
s21::tree<T, AllowDuplicate>::TreeIterator::TreeIterator(
    TreeIterator&& other) noexcept
    : current_(other.current_) {
  other.current_ = nullptr;
}

template <typename T, int AllowDuplicate>
const typename s21::tree<T, AllowDuplicate>::TreeIterator&
...
template <typename T, int AllowDuplicate>
bool s21::tree<T, AllowDuplicate>::TreeIterator::operator==(
...
template <typename T, int AllowDuplicate>
typename s21::tree<T, AllowDuplicate>::reference
s21::tree<T, AllowDuplicate>::TreeIterator::operator*() {
...
template <typename T, int AllowDuplicate>
const typename s21::tree<T, AllowDuplicate>::reference
s21::tree<T, AllowDuplicate>::TreeIterator::operator*() const {
  if (current_ == nullptr || current_ == nil_) {
    throw std::out_of_range("Dereferencing end iterator");
  }
  return current_->item;
...
template <typename T, int AllowDuplicate>
typename s21::tree<T, AllowDuplicate>::value_type*
s21::tree<T, AllowDuplicate>::TreeIterator::operator->() {
  if (current_ == nullptr || current_ == nil_) {
...
template <typename T, int AllowDuplicate>
const typename s21::tree<T, AllowDuplicate>::value_type*
s21::tree<T, AllowDuplicate>::TreeIterator::operator->() const {
  if (current_ == nullptr || current_ == nil_) {
    throw std::out_of_range("Accessing end iterator");
  }
...
s21::tree<T, AllowDuplicate>::TreeIterator::operator++() {
  if (this->current_ == this->end_node_) return *this;  // change
...
template <typename T, int AllowDuplicate>
typename s21::tree<T, AllowDuplicate>::TreeIterator
s21::tree<T, AllowDuplicate>::TreeIterator::operator++(int) {
  if (TreeSuccessor(this->current_) == this->end_node_) return *this;  // change
  iterator temp = *this;
  ++(*this);
  return temp;
}
...
s21::tree<T, AllowDuplicate>::TreeIterator::TreeSuccessor(BaseNode* x) {
  BaseNode* y;
  BaseNode* current = x;
...
template <typename T, int AllowDuplicate>
typename s21::tree<T, AllowDuplicate>::BaseNode*
s21::tree<T, AllowDuplicate>::TreeIterator::TreeDescendant(
